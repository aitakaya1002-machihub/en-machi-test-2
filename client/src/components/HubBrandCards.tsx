      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-sm p-6 border border-gray-100 hover:shadow-sm transition-shadow">
            <div className="mb-4 flex h-24 items-center justify-center overflow-hidden rounded-sm border border-[#4a5c4a]/10 bg-[#f8f7f5] px-5">
              <img
                src="/placeholders/moto-machi_mini.webp"
                alt="moto-machi"
          ...
          <div className="bg-white rounded-sm p-6 border border-gray-100 hover:shadow-sm transition-shadow">
            <div className="mb-4 flex h-24 items-center justify-center overflow-hidden rounded-sm border border-[#4a5c4a]/10 bg-[#f8f7f5] px-5">
              <img
                src="/placeholders/yado-machi_mini.webp"
                alt="yado-machi"
                className="max-h-10 w-auto max-w-full object-contain"
              />
            </div>
